...
type Logger interface {
	Info(ctx context.Context, msg string, field ...Field)
	Warn(ctx context.Context, msg string, field ...Field)
	Error(ctx context.Context, msg string, field ...Field)
	Debug(ctx context.Context, msg string, field ...Field)
	Sync()
}
